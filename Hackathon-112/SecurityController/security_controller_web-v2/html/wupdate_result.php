...
#$URL = "https://localhost:8443/restconf/data/i2nsf:policy/I2NSF/Policy_web='$Rule_id'";
#$result = shell_exec("curl --ipv4 --http2 -k --cert-type PEM -E $CLIENT_CERT -X GET $URL");
#$json = json_decode($result, true);

#$row1 = $json['i2nsf:Policy_web'][0]['Rule_name'];
#$row2 = $json['i2nsf:Policy_web'][0]['Position'];
#$row3 = $json['i2nsf:Policy_web'][0]['Web'];
#$row4 = $json['i2nsf:Policy_web'][0]['Start_time'];
#$row5 = $json['i2nsf:Policy_web'][0]['End_time'];
#$row6 = $json['i2nsf:Policy_web'][0]['Action'];
