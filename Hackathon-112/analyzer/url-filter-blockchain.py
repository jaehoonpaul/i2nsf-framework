...
res = requests.get("http://10.0.0.25:5000/api/querylastdata")
datas = json.loads(res.text)
print(datas)

lastmnumbers = datas["Key"]
lastmnumber = int(lastmnumbers[10:])
print(lastmnumber)
...
while True:
    ...
    lastmnumber = lastmnumber + 1

    mnumber = "monitoring"+str(lastmnumber)
    ...
    data = {"mNumber": mnumber,
            ...
            "eventTime":times,
            "in_traffic":in_traffic_speed,
            "memory_usage":memory_usage,
            "out_traffic":out_traffic_speed,
            "system_status":system_status,
            "nsf_name":nsf_name}
    res = requests.post("http://10.0.0.25:5000/api/adddata", json=data)
    print(res)
