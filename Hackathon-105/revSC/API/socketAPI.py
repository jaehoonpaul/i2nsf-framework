...
def receive_nsf_ip(IP, PORT):
  ...
  while True:
    ...
    data = data.split(",")
    #print("sudo /home/deploy/confd-6.6/bin/netconf-console --host "+data[1]+" /home/deploy/LowLevelPolicy/"+data[0]+".xml")
    os.system("/home/deploy/confd-6.6/bin/netconf-console --host "+data[1]+" /home/deploy/revSC/LowLevelPolicy/"+data[0]+".xml")
