...
static struct {const char* mac; const char* name;} manufacturers[] =
{
    ...
    {"00-09-5C", "Philips Medical Systems -"
     " Cardiac and Monitoring Systems (CM"},
    ...
    {"00-0B-2E", "Cal-Comp Electronics (Thailand) Public "
     "Company Limited Taipe"},
    {"00-0B-2F", "bplan GmbH"},
    ...
    {"00-0B-91", "Aglaia Gesellschaft für Bildverarbeitung und "
     "Kommunikation m"},
    ...
    {"00-13-83", "Application Technologies and Engineering Research"
     " Laboratory"},
    ...
    {"00-14-D5", "Datang Telecom Technology CO. , LCD,Optical "
     "Communication Br"},
    ...
    {"00-16-6D", "Yulong Computer Telecommunication"
     " Scientific(shenzhen)Co.,Lt"},
    ...
    {"00-19-93", "Changshu Switchgear MFG. Co.,Ltd. "
     "(Former Changshu Switchgea"},
    ...
    {"00-1D-AD", "Sinotech Engineering Consultants, Inc.  "
    ...
    {"00-1F-0A", "Nortel"},
    {"00-1F-0B", "Federal State Unitary Enterprise Industrial"
     " Union \"Electropribor\""},
    ...
    {"00-1F-21", "Inner Mongolia Yin An Science & Technology "
     "Development Co.,L"},
    ...
    {"00-1F-53", "GEMAC Gesellschaft für Mikroelektronikanwendung"
     " Chemnitz mbH"},
    ...
    {"00-1F-F8", "Siemens AG, Sector Industry, Drive Technologies, "
    ...
    {"00-22-D5", "Eaton Corp. Electrical Group Data Center Solutions -"
     " Pulizzi"},
    {"00-22-D6", "Cypak AB"},
    ...
    {"00-23-1F", "Guangda Electronic & Telecommunication Technology"
     " Development Co., Ltd."},
    ...
    {"00-23-41", "Siemens Building Technologies Fire & Security "
    ...
    {"00-23-C7", "AVSystem"},
    {"00-23-C8", "TEAM-R"},
    {"00-23-C9", "Sichuan Tianyi Information Science & Technology "
     "Stock CO.,LTD"},
    ...
    {"00-25-79", "J & F Labs"},
    {"00-25-7A", "CAMCO Produktions- und Vertriebs-GmbH für "
    ...
    {"EC-E9-F8", "Shenzhen Morlab Communications Technology Co., Ltd"},
...
const char* get_manufacturer(uint8_t mac0, uint8_t mac1, uint8_t mac2) {
    int i;
    char mac[128];
    sprintf(mac, "%02X-%02X-%02X", (unsigned)mac0,
            (unsigned)mac1, (unsigned)mac2);
    for (i = 0; strlen(manufacturers[i].mac) > 0; i++) {
        if (strcasecmp(mac, manufacturers[i].mac) == 0) {
