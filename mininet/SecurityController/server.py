...
# connect with DMS
registration_interface = threading.Thread(target=socketAPI.openRegistrationInterface, args=('127.0.0.1', 55552, dataconverter)) #EDIT WITH YOUR SECURITY_CONTROLLER IP
tacker_interface = threading.Thread(target=socketAPI.receive_nsf_ip, args=('127.0.0.1', 55560)) #EDIT WITH YOUR SECURITY_CONTROLLER IP
...
while True:
	...
	dataconverter.policyprovisioning(cfglist, '127.0.0.1', 55562) #EDIT WITH YOUR DMS IP
