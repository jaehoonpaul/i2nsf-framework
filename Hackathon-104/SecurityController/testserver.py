...
# connect with DMS
registration_interface = threading.Thread(target=socketAPI.openRegistrationInterface, args=('10.0.0.7', 55552, dataconverter))
tacker_interface = threading.Thread(target=socketAPI.receive_nsf_ip, args=('10.0.0.7', 55560))
